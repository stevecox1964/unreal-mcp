"""
Raw TCP socket connection to the Unreal bridge plugin on 127.0.0.1:55557.

Unreal closes the socket after each command, so `UnrealConnection` reconnects
per command rather than keeping a persistent connection alive.
"""
